...
namespace TaxiManagerApp9000.Services
{
    public class UIService : IUIService
    {
        ...
        public User LogIn()
        {
            TextHelper.TextGenerator("Taxi Manager 9000", ConsoleColor.Magenta);
            TextHelper.Separator();
            TextHelper.TextGenerator("Log In:", ConsoleColor.Magenta);
        ...
        {
            List<MenuOptions> menuItems = new List<MenuOptions>() { MenuOptions.ChangePassword, MenuOptions.BackToMenu,MenuOptions.Exit };
        ...
        public int ChooseMenu<T>(List<T> items)
        {
            ...
            {
                Console.Clear();
                TextHelper.TextGenerator("Please insert the ID of the element you want to choose:", ConsoleColor.Magenta);
